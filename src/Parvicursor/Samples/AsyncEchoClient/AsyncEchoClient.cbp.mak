...
LDFLAGS = -lpthread  -s
RCFLAGS = 
LDLIBS = $(T_LDLIBS) ../../AsyncSocketLib/Debug/AsyncSocketLib.lib ../../ParvicursorLib/Debug/ParvicursorLib.lib  -lstdc++
...
Debug_Win32_target.BIN = Debug/AsyncEchoClient.exe
Debug_Win32_target.OBJ = main.o 
DEP_FILES += main.d 
...
Debug_Win32_target : CFLAGS += -g -W -O0 -ll -D_DEBUG -D_CONSOLE  -Os
Debug_Win32_target : INCLUDES += 
Debug_Win32_target : RCFLAGS += 
Debug_Win32_target : LDFLAGS +=   
Debug_Win32_target : T_LDLIBS = 
ifdef LMAKE
